...
class ViewMoviesTest extends TestCase {
    ...
    public function the_main_page_shows_correct_info() {
        Http::fake([
            'https://api.themoviedb.org/3/movie/popular?api_key=f14092884639d7b4dc5fb2691bb23f13'     => $this->fakePopularMovies(),
            'https://api.themoviedb.org/3/movie/now_playing?api_key=f14092884639d7b4dc5fb2691bb23f13' => $this->fakeNowPlayingMovies(),
            'https://api.themoviedb.org/3/genre/movie/list?api_key=f14092884639d7b4dc5fb2691bb23f13'  => $this->fakeGenres(),
        ]);
